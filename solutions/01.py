...
expected = 2020
forward = sorted(xs)
backward = sorted(xs, reverse=True)
solution = 0
for front in forward:
    for back in backward:
        if front + back == expected:
            solution = front * back
            break
        elif front + back < expected:
            break
    if front + back == expected:
        break
...
forward = sorted(xs)
solution = 0
for front_1 in forward:
    for front_2 in forward:
        for front_3 in forward:
            actual = front_1 + front_2 + front_3
            if actual == expected:
                solution = front_1 * front_2 * front_3
                break
